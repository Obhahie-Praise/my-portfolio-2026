...
export const metadata: Metadata = {
  ...
  description: "Explore Praise Obhahie’s portfolio — a Nigerian designer and developer building viable digital products, thoughtful interfaces, and creative technical solutions.",
};
