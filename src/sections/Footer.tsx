...
const Footer = () => {
  return (
    <section id="footer" className="px-[50px]">
      <div className="flex items-end justify-between">
        <div className="flex items-start gap-x-[130px]">
          <div className="flex flex-col gap-[32px] leading-none tracking-[1%]">
            ...
            <Link href={"/"} className="cursor-link font-mono font-medium text-[32px]">
              Projects
            </Link>
            <Link href={"/"} className="cursor-link font-mono font-medium text-[32px]">
              Feats
      ...
      <h3 className="text-start font-medium text-[235px] tracking-[-1%] leading-none">
        Obhahie Praise
      </h3>
    </section>
  );
